...
- Pour faire fonctionner la carte, nous avons modifié les pins de la carte dans le code. Et on a effectué quelques autres modifications au niveau des librairies utilisées.
